...
- porceddu: Japs 88 — [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/) — [Fonte originale](https://commons.wikimedia.org/wiki/File:Porcetto_sardo_1.jpg). Asset: `images/enogastronomia/porceddu-sardo-japs88.webp`.

- fregola: Simon Legner (simon04) — [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/) — [Fonte originale](https://commons.wikimedia.org/wiki/File:Fregola_ai_frutti_di_mare_(IMG_20260515_203730).jpg). Asset: `images/enogastronomia/fregola-frutti-di-mare-simon-legner.webp`.

- malloreddus: Marica Massaro — [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/) — [Fonte originale](https://commons.wikimedia.org/wiki/File:Malloreddus.jpg). Asset: `images/enogastronomia/malloreddus-marica-massaro.webp`.

- pane_carasau: Luigi Chiesa — [CC BY 3.0](https://creativecommons.org/licenses/by/3.0/) — [Fonte originale](https://commons.wikimedia.org/wiki/File:Pane_carasau.jpg). Asset: `images/enogastronomia/pane-carasau-luigi-chiesa.webp`.

- seadas: Terendo — [Public domain](https://creativecommons.org/publicdomain/mark/1.0/) — [Fonte originale](https://commons.wikimedia.org/wiki/File:Seadas.JPG). Asset: `images/enogastronomia/seadas-terendo.webp`.

- pecorino: Jon Sullivan — [Public domain](https://creativecommons.org/publicdomain/mark/1.0/) — [Fonte originale](https://commons.wikimedia.org/wiki/File:Pecorino_sardo_cheese.jpg). Asset: `images/enogastronomia/pecorino-sardo-jon-sullivan.webp`.

- cannonau: Agne27 — [CC BY-SA 3.0](https://creativecommons.org/licenses/by-sa/3.0/) — [Fonte originale](https://commons.wikimedia.org/wiki/File:Cannonau_di_Sardegna.jpg). Asset: `images/enogastronomia/cannonau-di-sardegna-agne27.webp`.
