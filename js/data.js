...
const BEACHES = [
  ...
  },
  {
    ...
    "crowd": 3,
    "type": {
      "it": "tre calette di granito",
      "en": "three granite coves",
      "de": "drei Granitbuchten"
    },
    "coords": [
      39.117,
      9.505
    ...
    "best": "V–X",
    "parking": {
      "it": "lungo strada bianca, scarso",
      "en": "along dirt road, scarce",
      "de": "an Schotterstraße, knapp"
    },
    "services": {
      "it": "nessuno",
      "en": "none",
    ...
    "trails": {
      "it": "anello dei tre stagni",
      "en": "three-ponds loop",
      "de": "Runde der drei Teiche"
    },
    "wind": {
      "tramontana": 4,
      "grecale": 2,
    ...
    "desc": {
      "it": "Tre calette dorate tra macchia mediterranea e granito.",
      "en": "Three golden coves between Mediterranean scrub and granite.",
      "de": "Drei goldene Buchten zwischen Macchia und Granit."
    },
    "go": {
      "it": "Al mattino presto o a settembre.",
      "en": "Early morning or September.",
      "de": "Früh morgens oder im September."
    },
    "avoid": {
      "it": "A mezzogiorno d’estate: pochissima ombra.",
      "en": "Summer midday: almost no shade.",
      "de": "Mittags im Sommer: kaum Schatten."
    }
  },
  {
    "id": "molentis",
