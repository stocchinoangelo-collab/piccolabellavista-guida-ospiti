...
const DATA = {
  ...
  casa: {
    ...
    description: {
      it: "Un monovano di circa 33 m² a Pirri, al terzo piano senza ascensore. Una base accogliente per scoprire Cagliari e il Sud Sardegna.",
      en: "A studio of around 33 m² in Pirri, on the third floor with no lift. A welcoming base for exploring Cagliari and southern Sardinia."
    },
    wifi: {
    ...
    services: [
      ...
      { icon: "📶", label: { it: "Wi-Fi", en: "Wi-Fi" } },
      { icon: "🅿️", label: { it: "Parcheggio in strada", en: "Street parking" } },
      { icon: "🍳", label: { it: "Cucina attrezzata", en: "Equipped kitchen" } },
      { icon: "🧺", label: { it: "Lavatrice", en: "Washing machine" } },
      { icon: "☕", label: { it: "Moka", en: "Moka pot" } }
    ],
    rules: [
